    ...
    <div className="min-h-screen bg-[#f0f0e8] text-[#1a1a1a] font-mono">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="max-w-2xl mt-8">
            <p className="text-2xl sm:text-3xl font-bold leading-tight">
              ...
              <br />
              <span className="text-[#FF6600]">Less features. No bull$#!t.</span>
            </p>
          </div>
      ...
      <section className="px-6 py-16">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl font-black mb-2">How snip compares</h2>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-[#1a1a1a] text-[#f0f0e8] p-8">
              <div className="text-sm tracking-widest text-[#FFB380] mb-4">PRICING MODEL</div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="border-2 border-[#FF6600] p-6">
                <div className="font-black text-[#FF6600] mb-2">snip</div>
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-8">
            {[
              ...
              <div key={i} className="flex items-center gap-4">
                <span className="w-16 h-16 bg-[#FF6600] flex items-center justify-center text-3xl font-black">
                  {item.step}
                </span>
                <div>
